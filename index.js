...
// ANSWER: No, O(1) is the fastest time complexity.
...
// 7) -------------------------------------------------------
let numbersTwo = [76,35,73,13,4,88,23,12,86,1,54,9,10,2]
// remember numbers could be reassigned, added to, etc.
let newNumbersA = numbersTwo.filter((num) => {
  return num < 5
})
...
let newNumbersB = numbersTwo.map((num) => {
  return num * 3
})
...
// ANSWER: They each loop through the data multiple times
